			...
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="main_title">
						<h2>My Skills</h2>
						<p>
							This is a list of the skills that i currently master, however this section is always changing
                            <br>as i am always learning and challenging myself.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="footer_top flex-column">
						...
						<div class="footer_social">
							<a href="https://www.linkedin.com/in/rabahdjebbes/" target="_blank"><i class="fa fa-linkedin"></i></a>
							<a href="https://github.com/rabahdj2002" target="_blank"><i class="fa fa-github"></i></a>
							<a href="mailto:rabahwork@gmail.com" target="_blank"><i class="fa fa-envelope-square"></i></a>
							<a href="tel:+213558605921"><i class="fa fa-phone-square"></i></a>
						</div>
					</div>
				</div>
			</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="https://www.linkedin.com/in/rabahdjebbes/" target="_blank">Rabah Djebbes</a>
